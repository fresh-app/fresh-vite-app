...
export declare function getDepHash(root: string, configFile: string | undefined): string;
...
export declare function resolvePackageEntry(id: string, { resolvedImports, dir, data }: PackageData): string | undefined;
